...
![image-20260502191859548](/posts/大模型学习笔记/images/image-20260502191859548.png)
...
![image-20260502185200359](/posts/大模型学习笔记/images/image-20260502185200359.png)

![image-20260502185232675](/posts/大模型学习笔记/images/image-20260502185232675.png)

![image-20260502185250781](/posts/大模型学习笔记/images/image-20260502185250781.png)
...
![image-20260502190947102](/posts/大模型学习笔记/images/image-20260502190947102.png)
...
![image-20260502185103893](/posts/大模型学习笔记/images/image-20260502185103893.png)
...
我们要把文本"我 爱"变成矩阵。假设模型内部已经有一个训练好的词嵌入矩阵 $W_{emb}$ 和位置编码矩阵 $P$。
...
$$V_{last} = \begin{bmatrix} 2 & 2 \end{bmatrix} \quad \text{(形状: } 1 \times 2 \text{)}$$

**第 2 步：与词汇字典映射**

模型最后有一个语言模型头矩阵 $W_{vocab}$。它的形状是 $2 \times 4$（2 维特征，对应 4 个候选词）。

假设模型经过训练，在"我爱"这种语境下，后面接"AI"的概率极高：

$$W_{vocab} = \begin{bmatrix} 1 & -1 & 5 & 0 \\ 0 & 1 & 3 & 2 \end{bmatrix} \quad \begin{matrix} \leftarrow \text{特征 1} \\ \leftarrow \text{特征 2} \end{matrix}$$
...
| **FFN** | $W_{up}, W_{down}$ | 知识加工与逻辑处理 |
| **LM Head** | $W_{unembed}$ | 向量转词概率 |
...
![image-20260624001523666](/posts/大模型学习笔记/images/image-20260624001523666.png)
